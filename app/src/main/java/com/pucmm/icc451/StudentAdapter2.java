...
public class StudentAdapter2 extends RecyclerView.Adapter<StudentAdapter2.StudenViewHolder> {

    private final List<Student> students;

    public StudentAdapter2(List<Student> students) {
    ...
    public StudenViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new StudentAdapter2.StudenViewHolder(view);
    }
